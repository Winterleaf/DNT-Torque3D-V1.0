...
namespace DNT_FPS_Demo_Game_Dll.Scripts.Client
    ...
    public partial class Main : TorqueScriptTemplate
        ...
        public bool sfxInit()
            ...
            if (!Util.sfxCreateDevice(console.GetVarString("$pref::SFX::provider"), console.GetVarString("$pref::SFX::device"), console.GetVarBool("$pref::SFX::useHardware"), maxBuffers))
                return false;
            ...
            if (Util._isDefined("$pref::SFX::distanceModel"))
                {
                SFXDistanceModel t;
                if (Enum.TryParse(console.GetVarString("$pref::SFX::distanceModel"), out t))
                    {
        ...
        public void sfxShutdown()
            ...
            for (int channel = 0; channel <= 8; channel++)
                console.SetVar("$pref::SFX::channelVolume[" + channel.AsString() + "]", console.Call("sfxGetChannelVolume", new[] {channel.AsString()}));
        ...
        public void sfxPause(string channels, string pauseSet)
            ...
            for (uint i = 0; i < count; i++)
                ...
                if (channel != "" && console.Call("findWord", new[] {channels, channel}).AsInt() == -1)
                    continue;
