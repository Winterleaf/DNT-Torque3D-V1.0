...
namespace DNT_FPS_Demo_Game_Dll.Scripts.Client
    ...
    public partial class Main : TorqueScriptTemplate
        ...
        public void clientCmdMissionEnd(string seq)
            {
            if (!console.GetVarBool("$Client::missionRunning") || console.GetVarString("$Client::missionSeq") != seq)
                return;
            clientEndMission();
        ...
        public string loadLevel(string missionNameOrFile)
            ...
            if (console.isObject("LoadingGui"))
                ...
                console.Call("LoadingProgress", "setValue", new[] {"1"});
                console.Call("LoadingProgressTxt", "setValue", new[] {"LOADING MISSION FILE"});
