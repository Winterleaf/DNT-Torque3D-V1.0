...
namespace WinterLeaf.Enums
    ...
    //    /// <summary>
    //    /// he window has a sizing border. Same as the WS_SIZEBOX style.
    //    /// </summary>
    ...
    public enum SetWindowLongNIndex
        {
        /// <summary>
    ...
    public enum ShowWindownCMDShow
        {
        SW_SHOWNORMAL = 1,
        SW_SHOWNOACTIVATE = 4,
        SW_SHOWNA = 8,
    ...
    internal static class SWP
        {
        public static readonly int NOSIZE = 0x0001, NOMOVE = 0x0002, NOZORDER = 0x0004, NOREDRAW = 0x0008, NOACTIVATE = 0x0010, DRAWFRAME = 0x0020, FRAMECHANGED = 0x0020, SHOWWINDOW = 0x0040, HIDEWINDOW = 0x0080, NOCOPYBITS = 0x0100, NOOWNERZORDER = 0x0200, NOREPOSITION = 0x0200, NOSENDCHANGING = 0x0400, DEFERERASE = 0x2000, ASYNCWINDOWPOS = 0x4000;
        }
